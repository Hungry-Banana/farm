...
-- --- INITIAL SERVERS (IDs 1-7) ---
('dev-web-01','x86_64','PowerEdge R750','Dell','DW750001','Dell','DW750001C','COMPUTE','ACTIVE','DEVELOPMENT',1,1,1,1,10,'2025-11-28 08:00:00','1.5.2'),
('dev-db-01','x86_64','PowerEdge R750','Dell','DW750002','Dell','DW750002C','STORAGE','ACTIVE','DEVELOPMENT',1,1,1,1,11,'2025-11-28 08:30:00','1.5.2'),
('dev-storage-01','x86_64','ProLiant DL380 Gen10 Plus','HPE','HP380001','HPE','HP380001C','STORAGE','ACTIVE','DEVELOPMENT',1,2,1,1,12,'2025-11-28 07:45:00','1.5.1'),
('prod-web-01','x86_64','X11DPH-T','Supermicro','SM001WEB','Supermicro','SM001WEBC','COMPUTE','ACTIVE','PRODUCTION',2,4,2,5,20,'2025-11-28 06:00:00','1.6.0'),
('prod-db-01','x86_64','X11DPH-T','Supermicro','SM002DB','Supermicro','SM002DBC','STORAGE','ACTIVE','PRODUCTION',2,6,2,5,21,'2025-11-28 06:15:00','1.6.0'),
('maint-util-01','x86_64','WS C621E SAGE','ASUS','AS001UTIL','ASUS','AS001UTILC','BAREMETAL','MAINTENANCE','TESTING',0,0,1,2,5,'2025-11-27 14:30:00','1.4.8'),
('new-srv-01','x86_64','EPYCD8-2T','ASRock Rack','AR001NEW','ASRock Rack','AR001NEWC','BAREMETAL','NEW','STAGING',0,0,1,3,8,NULL,NULL),
...
-- ===================================================================
-- SERVER MOTHERBOARDS (one per server, IDs 1-107)
...
-- ===================================================================
-- SERVER CPUS (dual socket configs per server, IDs 1-107)
-- CPU selection:
...
-- ===================================================================
-- SERVER MEMORY (8 DIMMs per server, IDs 1-107)
-- Memory selection:
...
SELECT s.server_id,
    ...
    'healthy'
FROM servers s WHERE s.server_id BETWEEN 1 AND 107;
...
FROM servers s WHERE s.server_id BETWEEN 1 AND 107 AND s.server_type = 'STORAGE';
...
FROM servers s
WHERE s.server_id BETWEEN 1 AND 107 AND s.sub_cluster_id = 14;
...
FROM servers s
WHERE s.server_id BETWEEN 1 AND 107 AND s.cluster_id = 3;

-- ===================================================================
-- SERVER NETWORK INTERFACES (IDs 1-107)
...
-- ===================================================================
-- SERVER BMC INTERFACES (IDs 1-107)
...
-- ===================================================================
-- SERVER CREDENTIALS (OS authentication, IDs 1-107)
-- ===================================================================
