...
INSERT IGNORE INTO datacenter_rack_positions (rack_id, u_position, status, reserved_for, device_type, notes) VALUES 
(1, 1, 'OCCUPIED', NULL, 'SERVER', 'PDU mounted at bottom'),
(1, 2, 'OCCUPIED', NULL, 'SERVER', NULL),
(1, 3, 'OCCUPIED', NULL, 'SERVER', 'Dell R750 - 2U server'),
(1, 5, 'AVAILABLE', NULL, NULL, NULL),
(1, 6, 'AVAILABLE', NULL, NULL, NULL),
(1, 7, 'AVAILABLE', NULL, NULL, NULL),
(1, 8, 'AVAILABLE', NULL, NULL, NULL),
(1, 9, 'AVAILABLE', NULL, NULL, NULL),
(1, 10, 'OCCUPIED', NULL, 'SERVER', 'dev-web-01'),
(1, 11, 'OCCUPIED', NULL, 'SERVER', 'dev-db-01'),
(1, 12, 'OCCUPIED', NULL, 'SERVER', 'dev-storage-01'),
(1, 13, 'RESERVED', 'Future expansion', NULL, 'Reserved for Q2 deployment'),
(1, 14, 'RESERVED', 'Future expansion', NULL, 'Reserved for Q2 deployment'),
(1, 15, 'RESERVED', 'Future expansion', NULL, 'Reserved for Q2 deployment'),
(1, 16, 'AVAILABLE', NULL, NULL, NULL),
(1, 17, 'AVAILABLE', NULL, NULL, NULL),
(1, 18, 'AVAILABLE', NULL, NULL, NULL),
(1, 19, 'AVAILABLE', NULL, NULL, NULL),
(1, 20, 'AVAILABLE', NULL, NULL, NULL),
(1, 21, 'OCCUPIED', NULL, 'SWITCH', 'TOR Switch'),
(1, 22, 'OCCUPIED', NULL, 'SWITCH', 'Management Switch'),
(1, 40, 'OCCUPIED', NULL, 'PDU', 'PDU A'),
(1, 41, 'OCCUPIED', NULL, 'PDU', 'PDU B'),
(1, 42, 'BLOCKED', NULL, NULL, 'Cable management');

-- Rack 2 (SFO-LAB-01-R02) - Sample positions
INSERT IGNORE INTO datacenter_rack_positions (rack_id, u_position, status, reserved_for, device_type, notes) VALUES 
(2, 1, 'AVAILABLE', NULL, NULL, NULL),
(2, 2, 'AVAILABLE', NULL, NULL, NULL),
(2, 3, 'AVAILABLE', NULL, NULL, NULL),
(2, 4, 'AVAILABLE', NULL, NULL, NULL),
(2, 5, 'OCCUPIED', NULL, 'SERVER', 'maint-util-01'),
(2, 6, 'AVAILABLE', NULL, NULL, NULL),
(2, 7, 'AVAILABLE', NULL, NULL, NULL),
(2, 8, 'OCCUPIED', NULL, 'SERVER', 'new-srv-01'),
(2, 9, 'AVAILABLE', NULL, NULL, NULL),
(2, 10, 'AVAILABLE', NULL, NULL, NULL),
(2, 40, 'OCCUPIED', NULL, 'PDU', 'PDU A'),
(2, 41, 'OCCUPIED', NULL, 'PDU', 'PDU B'),
(2, 42, 'BLOCKED', NULL, NULL, 'Cable management');

-- Rack 5 (DFW-PROD-01-R02) - Sample positions (Production)
INSERT IGNORE INTO datacenter_rack_positions (rack_id, u_position, status, reserved_for, device_type, notes) VALUES 
(5, 1, 'OCCUPIED', NULL, 'UPS', 'Rack UPS'),
(5, 2, 'OCCUPIED', NULL, 'PDU', 'Managed PDU'),
(5, 3, 'AVAILABLE', NULL, NULL, NULL),
(5, 4, 'AVAILABLE', NULL, NULL, NULL),
(5, 5, 'AVAILABLE', NULL, NULL, NULL),
(5, 10, 'AVAILABLE', NULL, NULL, NULL),
(5, 15, 'AVAILABLE', NULL, NULL, NULL),
(5, 20, 'OCCUPIED', NULL, 'SERVER', 'prod-web-01'),
(5, 21, 'OCCUPIED', NULL, 'SERVER', 'prod-db-01'),
(5, 22, 'AVAILABLE', NULL, NULL, NULL),
(5, 23, 'AVAILABLE', NULL, NULL, NULL),
(5, 24, 'AVAILABLE', NULL, NULL, NULL),
(5, 25, 'AVAILABLE', NULL, NULL, NULL),
(5, 30, 'AVAILABLE', NULL, NULL, NULL),
(5, 35, 'AVAILABLE', NULL, NULL, NULL),
(5, 40, 'OCCUPIED', NULL, 'SWITCH', 'Core Switch'),
(5, 41, 'OCCUPIED', NULL, 'SWITCH', 'TOR Switch'),
(5, 45, 'OCCUPIED', NULL, 'PDU', 'PDU A'),
(5, 46, 'OCCUPIED', NULL, 'PDU', 'PDU B'),
(5, 47, 'OCCUPIED', NULL, 'PDU', 'PDU C'),
(5, 48, 'BLOCKED', NULL, NULL, 'Cable management');
